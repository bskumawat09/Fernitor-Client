                    ...
                    <div className="row">
                        <div className="col-10 mx-auto text-center col-lg-6 my-lg-5">
                            <div className="img-container">
                                <img src={product.image?.url} className="single-big-img" alt="" />
                            </div>
                        ...
                        <div className="col-10 mx-auto col-lg-6 single-product-info my-lg-5 px-lg-5">
                            ...
                            <h5 className="text-capitalize my-3">
                                available :
                                <span className="text-capitalize ms-2">{product.inStock ? "In Stock" : "Out of Stock"}</span>
                            </h5>
                            ...
                            <div className="d-flex align-items-center my-2">
                                <Remove className="qty-btn me-2" style={{ cursor: 'pointer' }} onClick={() => handleQuantity("decrement")} />
                                <span className="text-capitalize number">{quantity}</span>
                                <Add className="qty-btn ms-2" style={{ cursor: 'pointer' }} onClick={() => handleQuantity("increment")} />
                                <div className="text-capitalize add-to-cart-icon-btn ms-5" onClick={handleAddToCart}>
                                    add to cart
                                </div>
                            </div>
                        </div>
